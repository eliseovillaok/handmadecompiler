...
{FileHandler.appendToFile(filePathParser,"ASIGNACION MULTIPLE");
                                                                         yyval.obj = new NodoAsignacionMultiple(":=",(Nodo)val_peek(3).obj,(Nodo)val_peek(1).obj, val_peek(3).sval, val_peek(1).sval);
...
{actualizarUso(val_peek(2).sval, "Variable"); actualizarUso(val_peek(0).sval, "Variable");
                                                          ...
                                                          yyval.obj = new NodoLista(",",new NodoConcreto(val_peek(2).sval, hijoIzq.getType()),new NodoConcreto(val_peek(0).sval, hijoDer.getType()));}
break;
case 53:
...
{actualizarUso(val_peek(0).sval, "Variable");
                                            ...
                                            yyval.obj = new NodoLista(",",(Nodo)val_peek(2).obj,new NodoConcreto(val_peek(0).sval, simbolo.getType()));}
break;
case 55:
