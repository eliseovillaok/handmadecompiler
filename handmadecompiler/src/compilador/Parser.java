...
//#line 188 "gramatica.y"
{
                                ...
                                if(simbolo != null){
                                    yyval.obj = new NodoCompuestoBinario(":=",new NodoConcreto(val_peek(3).sval + ":" + val_peek(5).sval, simbolo.getType()),(Nodo)val_peek(1).obj); /* Lo creamos compuesto*/
                                    FileHandler.appendToFile(filePathParser,"ASIGNACION");
                                }else{
                                    yyerror(VARIABLE_NO_DECLARADA);
                                }
